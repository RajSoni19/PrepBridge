  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'streak-glow': 'var(--shadow-streak-glow)',
        'soft': 'var(--shadow-md)',
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsla(234, 89%, 60%, 0.3)" },
          "50%": { boxShadow: "0 0 40px hsla(234, 89%, 60%, 0.5)" },
        },
        "shimmer": {
      ...
      animation: {
        ...
        "streak": "streak-flame 2s ease-in-out infinite",
